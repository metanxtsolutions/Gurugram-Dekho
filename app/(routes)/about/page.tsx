...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-fg mb-6">About Gurugram Dekho</h1>
      ...
      <div className="prose max-w-none">
        ...
        <h2 className="text-2xl font-bold text-fg mt-8 mb-4">Our Mission</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-fg mt-8 mb-4">Why Choose Us?</h2>
