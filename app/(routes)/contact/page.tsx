...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-fg mb-6">Contact Us</h1>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-fg-muted">Gurugram, Haryana, India</p>
            </div>
          </div>
        </div>

        <div>
          <h2 className="text-xl font-bold text-fg mb-4">Send us a Message</h2>
          {submitted ? (
